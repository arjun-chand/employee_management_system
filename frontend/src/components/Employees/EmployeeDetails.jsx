...
export default function EmployeeDetails() {
    ...
    const getEmployeeDetails = async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:3100/emp/employeeDetail/${params.id}`);
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmed) {
            try {
                ...
                let response = await axios.delete(`http://localhost:3100/emp/delete/${id}`);
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await axios.put(`http://localhost:3100/emp/update/${employee._id}`, updatedEmployee);
